<div id="sidebar" class="d-flex flex-column p-3"> 
    ...
    <div class="d-flex text-white align-items-center logo_box border-bottom border-2 pb-2">
            <img src="<?= '/img/logo_uc.png' ?>" class="main_logo"/>
            <h3 class="d-none d-xl-block">
                Admin Dashboard
            </h3>
        </div>
    </a>
    <div class="menu_box d-flex flex-column">
